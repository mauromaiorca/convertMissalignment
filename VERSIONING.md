...
The top-level `VERSION` file also contains `0.1.15` for workflow provenance. Both values must be updated together for a future release.
...
9. Commit and create a matching Git tag, such as `v0.1.15`.
